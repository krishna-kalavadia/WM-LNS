# NOTE: environment code taken from https://github.com/kwonathan/franka-kitchen-pybullet
...
def loadFrankaKitchen():
    ...
    kitchen = p.loadURDF("wm_lns/manipulator_experiments/kitchen_assets/kitchen_env_model.urdf", config.kitchenStartPosition, kitchenStartOrientationQ, useFixedBase=True, globalScaling=config.kitchenGlobalScaling)
    kettle = p.loadURDF("wm_lns/manipulator_experiments/kitchen_assets/item_assets/kettle.urdf", config.kettleStartPosition, kitchenStartOrientationQ, useFixedBase=False, globalScaling=config.kitchenGlobalScaling)

    # Change textures
    textureMarble = p.loadTexture("wm_lns/manipulator_experiments/kitchen_assets/textures/marble1.png")
    textureMetal = p.loadTexture("wm_lns/manipulator_experiments/kitchen_assets/textures/metal1.png")
